...
//#endregion
//#endregion
//#region - fullDataSystem TESTS
// these are going to be very similar to the tests for localFS and ATLAS API,
// fullDataSystem is meant to expose all of these DB options in one class
//#region tests using localFS
//#region CREATE tests
unit["fullDataSystem - FScreate - promisify version of create works as expected"] = function (done) {
    return __awaiter(this, void 0, void 0, function* () {
        // make it so this is in fakeData dir
        // localFS.overrideDefaultDataPath("fedora/lib/test/fakeData");
        // ONE AT A TIME EXAMPLE
        // create a data struct
        data_1.fullDataSystem.createDataStructure("testStruct", {
            testing: 'boolean'
        });
        // create the file
        yield data_1.fullDataSystem.promiseCreate("", "testFile", 'testStruct', { testing: true });
        // delete the file
        yield local_1.localFS.promiseDelete("", "testFile");
        // CONCURRENT EXAMPLE
        // create a bunch of files
        const file1Prom = data_1.fullDataSystem.promiseCreate("", "testFile1", "testStruct", { testing: true });
        const file2Prom = data_1.fullDataSystem.promiseCreate("", "testFile2", "testStruct", { testing: true });
        const file3Prom = data_1.fullDataSystem.promiseCreate("", "testFile3", "testStruct", { testing: true });
        const file4Prom = data_1.fullDataSystem.promiseCreate("", "testFile4", "testStruct", { testing: true });
        const file5Prom = data_1.fullDataSystem.promiseCreate("", "testFile5", "testStruct", { testing: true });
        yield Promise.all([file1Prom, file2Prom, file3Prom, file4Prom, file5Prom]);
        // delete a bunch of files
        const file1DeleteProm = data_1.fullDataSystem.promiseDelete("", "testFile1");
        const file2DeleteProm = data_1.fullDataSystem.promiseDelete("", "testFile2");
        const file3DeleteProm = data_1.fullDataSystem.promiseDelete("", "testFile3");
        const file4DeleteProm = data_1.fullDataSystem.promiseDelete("", "testFile4");
        const file5DeleteProm = data_1.fullDataSystem.promiseDelete("", "testFile5");
        yield Promise.all([file1DeleteProm, file2DeleteProm, file3DeleteProm, file4DeleteProm, file5DeleteProm]);
        done();
    });
};
unit["fullDataSystem - FScreate - throws errors as expected"] = function (done) {
    return __awaiter(this, void 0, void 0, function* () {
        // create a data struct
        data_1.fullDataSystem.createDataStructure("testStruct", {
            testing: 'boolean'
        ...
        // bad dsname
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", 'imbad', { testing: true });
        }), "bad dsname, so it should have thrown");
        // bad stuff
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStruct", 123123);
        }), "bad stuff, so it should have thrown");
        // bad dsanme and bad stuff
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStr", [{ testing: true }, 123]);
        }), "bad dsanme and bad stuff, so it should have thrown");
        // dsname and stuff dont match
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStruct", { testing: 123 });
        }), "dsname and stuff dont match, so it should have thrown");
        // if passed object[], should error
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStruct", [{ testing: true }]);
        }), "passed it Object[], so it should have thrown");
        // if passed bad dir, should error
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("badDirName", "testStruct", "testFile", { testing: true });
        }), "passed bad dir name, so it should have thrown");
        // if passed bad fileName, should error
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile.json", "testStruct", { testing: true });
        }), "passed bad fileName, so it should have thrown");
        // if pass bad data should error
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStruct", "bad input (should be object)");
        }), "passed bad data, so it should have thrown");
        // if file already exists, should error
        yield assert_1.default.rejects(() => __awaiter(this, void 0, void 0, function* () {
            yield data_1.fullDataSystem.promiseCreate("", "testFile", "testStruct", { testing: true });
        ...
        // delete the file made twice
        yield data_1.fullDataSystem.promiseDelete("", "testFile");
        done();
    });
};
//#endregion CREATE tests
