...
const https_1 = __importDefault(require("https")); //its http all over agian
const fs_1 = __importDefault(require("fs")); //read da FILES!!!!
const path_1 = __importDefault(require("path")); //normalize paths to different directories
...
class MyServer {
    constructor() {
        ...
        const httpsServerOptions = {
            "key": fs_1.default.readFileSync(path_1.default.join(__dirname, "/../../https/key.pem"), "utf8"),
            "cert": fs_1.default.readFileSync(path_1.default.join(__dirname, "/../../https/server.crt"), "utf8")
        };
        this.httpsServer = https_1.default.createServer(httpsServerOptions, (req, res) => {
            this.unifiedServer(req, res);
        });
    }
    ...
    init() {
        ...
        // start HTTPS server
        this.httpsServer.listen(config_1.default.httpsPort, function () {
            console.log("\x1b[35m%s\x1b[0m", `listening on port ${config_1.default.httpsPort} envName:${config_1.default.envName}`);
        });
    }
    ;
}
